...
class TopRecommendedTaskWidget extends StatelessWidget {
    ...
    return _PopScaleButton(
      ...
      onTap: () {
        ...
        if (!SplashService.isScreenEnabled('superOffer')) {
          _showUpcomingBottomSheet(context);
          return;
        }
  ...
  Widget _buildDiamondCatchCard(BuildContext context) {
    return _PopScaleButton(
      scaleDown: 0.95,
      onTap: () {
        HapticFeedback.lightImpact();
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Play Now Button - Flush to Right edge like royal_ninja card
              Positioned(
                right: 0,
                bottom: 12.h,
                child: _PopScaleButton(
  ...
  void _showUpcomingBottomSheet(BuildContext context) {
