...
class QuizResultReportScreen extends ConsumerWidget {
  ...
  void _handleShareResult({
    ...
    final String statusHeader = isWinner
        ? '🏆 I just WON a 1v1 Quiz Battle in royal_ninja!'
        : '⚔️ I just played an intense 1v1 Quiz Battle in royal_ninja!';
...
🔥 Can you beat my score? Challenge me in royal_ninja Quiz Battle Arena!$refText

📲 Download & Play now: $referralLink''';

    Share.share(
      shareMessage,
      subject: '⚔️ royal_ninja Quiz Battle Match Result',
    );
  }
