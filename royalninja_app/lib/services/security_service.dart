...
class SecurityService {
  ...
  static const List<int> _kSecMask = [0x52, 0x6f, 0x79, 0x61, 0x6c, 0x4e, 0x69, 0x6e, 0x6a, 0x61]; // "RoyalNinja"
  static const List<int> _kSecBytes = [
    32, 0, 0, 0, 0, 32, 0, 0, 0, 0, 13, 28, 28, 2, 51, 43, 81, 92, 8, 86,
    99, 86, 77, 7, 92, 120, 8, 93, 95, 5, 107, 12, 75, 89, 9, 122, 94, 95,
    8, 81, 103, 14, 79, 82, 85, 42, 91
  ];
