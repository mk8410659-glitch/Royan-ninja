...
class CustomToast {
  ...
  //! Custom Device Limit Reached Dialog (royal_ninja Luxury Theme)
                  ...
                  onTap: () async {
                    ...
                    if (_rating >= 4) {
                      ...
                      await LaunchUrl.openSupportMail(
                        context: context,
                        subject: 'App Feedback - royal_ninja',
                      );
                    }
                  },
                ),
              ...
              children: [
                ...
                Text(
                  validEmails.isNotEmpty
                      ? 'Only 1 royal_ninja account is allowed per device. This device is already linked to the account shown below.'
                      : (subTitle.isNotEmpty
                          ? subTitle
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await LaunchUrl.openSupportMail(
                      context: context,
                      subject: 'Device Limit Assistance - royal_ninja',
                    );
                  },
                  child: Padding(
                    padding: EdgeInsets.symmetric(vertical: 4.h),
