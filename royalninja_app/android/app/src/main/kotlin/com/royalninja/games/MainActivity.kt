...
class MainActivity: FlutterActivity() {
    private val CHANNEL = "com.royalninja.games/app_manager"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                val channelId = "royalninja"
                val channelName = "royal_ninja"
                val channelDescription = "royal_ninja Notifications and Reward Updates"
