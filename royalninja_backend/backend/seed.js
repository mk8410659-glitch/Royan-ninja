...
async function seed() {
    const mongoUri = process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/royalninja';
    ...
    try {
        ...
        if (!fs.existsSync(serviceAccountKeyPath)) {
            ...
            const appName = 'royalninja';
            const displayName = 'royal_ninja';
        ...
        // =====================================================================
        // 3. SEED APPDATA ADS CONFIG
        // =====================================================================
        console.log('\n📱 Seeding AppData Ads Configuration...');
        const AppData = require('./admin/models/appData');
        const defaultAdsConfig = {
            interstitialKey: 'n6aae9239d83ae',
            rewardedKey: 'n6aae923b1d826',
            nativeKey: 'n6aae923bdc67c',
            bannerKey: '',
            enabled: true,
            homeNativeEnabled: true,
            superOfferNativeEnabled: true,
            dailyChallengeNativeEnabled: true,
            playGamesNativeEnabled: true,
            watchVideoNativeEnabled: true,
        };
        ...
        console.log('✅ AppData Ads Config seeded successfully with Royal Ninja ad units.');
