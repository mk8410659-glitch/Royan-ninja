...
function getServiceAccountPath() {
    const candidatePaths = [
        ...
        '/home/zodplaygames-royalninja/htdocs/royalninja.zodplaygames.com/serviceAccountKey.json',
        '/home/zodplaygames-royalninja/htdocs/royalninja.zodplaygames.com/backend/serviceAccountKey.json'
    ];
...
const SCREEN_NAMES_MAP = {
    ...
    'ninjacatchscreenroute': { name: 'Ninja Catch Game', route: '/ninja-catch', category: 'Earning', icon: 'fa-solid fa-gamepad' },
    'diamondcatchscreenroute': { name: 'Ninja Catch Game', route: '/ninja-catch', category: 'Earning', icon: 'fa-solid fa-gamepad' },
...
router.post('/api/app-tracking/test-connection', adminAuth, async (req, res) => {
    try {
        ...
        if (userMsg.includes('Google Analytics Data API has not been used in project') || userMsg.includes('is disabled')) {
            userMsg = 'Google Analytics Data API is disabled in your Google Cloud Project. Please enable it with 1-click here: https://console.developers.google.com/apis/api/analyticsdata.googleapis.com/overview?project=751087523012';
        } else if (userMsg.includes('PERMISSION_DENIED') || userMsg.includes('does not have permission')) {
            userMsg = 'Permission Denied: Please make sure you have added firebase-adminsdk-fbsvc@royal-ninja-68760.iam.gserviceaccount.com as Viewer in your GA4 Property Access Management.';
