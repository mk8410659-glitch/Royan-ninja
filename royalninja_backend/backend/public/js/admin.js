...
const ALL_APP_ROUTES = [
    ...
    { value: 'app://ninja_catch', label: 'Ninja Catch Screen' },
...
function openQuickLookupPrompt() {
    const selectedApp = String(document.getElementById('appSelect')?.value || localStorage.getItem('selectedApp') || 'royal_ninja').trim();
