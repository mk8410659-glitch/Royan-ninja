...
// Curated unique notifications based on actual app tasks (Ninja Catch, Play Games, Super Offer, Daily Target, Invite, etc.)
const notifications = [
    // === MORNING SLOTS ===
    {
        "category": "morning",
    ...
    {
        "category": "morning",
        "title": "Morning Ninja Catch! 🎮",
        "body": "Play Ninja Catch game and earn gems!",
        "buttons": [
    ...
    {
        "category": "afternoon",
        "title": "Afternoon Ninja Catch! 🎮",
        "body": "Play Ninja Catch and win gems!",
        "buttons": [
            { "id": "play_game", "text": "Play Now" },
            { "id": "open_app", "text": "Open App" }
        ]
    ...
    // === EVENING SLOTS ===
    {
        ...
        "body": "Ninja Catch limit is refreshed. Play now and catch gems to win rewards.",
        "buttons": [
            { "id": "play_game", "text": "Catch Gems" },
            { "id": "open_app", "text": "Open App" }
        ]
    ...
    },
    {
        ...
        "body": "Tell your friends about royal_ninja. Earn level commissions together!",
        "buttons": [
    ...
    {
        "category": "night",
        "title": "Bedtime Ninja Catch! 🎮",
        "body": "Play a quick session of Ninja Catch and add extra gems to your wallet.",
        "buttons": [
            { "id": "play_game", "text": "Catch Gems" },
            { "id": "open_app", "text": "Open App" }
        ]
    ...
    {
        "category": "general",
        "title": "Ninja Catch is active! 🎮",
        "body": "Tap to play Ninja Catch and claim your free daily gems.",
        "buttons": [
    ...
    },
    {
        ...
        "body": "Learn how to use royal_ninja and earn free learning bonus coins.",
        "buttons": [
